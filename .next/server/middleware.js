...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_ts_page_2Fmiddleware_rootDir_C_3A_5CUsers_5CHP_5CDownloads_5Copt_web_main_5Copt_web_main_matchers_)
});
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.ts&page=%2Fmiddleware&rootDir=C%3A%5CUsers%5CHP%5CDownloads%5Copt_web-main%5Copt_web-main&matchers=!
        ...
        /* harmony default export */ function next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_ts_page_2Fmiddleware_rootDir_C_3A_5CUsers_5CHP_5CDownloads_5Copt_web_main_5Copt_web_main_matchers_(opts) {
          return adapter({
              ...opts,
              page: "/middleware",
              handler,
...
function middleware(req) {
    ...
    if (token && path === "/login") {
        return next_dist_server_web_exports_next_response__WEBPACK_IMPORTED_MODULE_0__/* ["default"].redirect */ .Z.redirect(new URL("/", req.url));
    } else if (token && path.includes("/home")) return next_dist_server_web_exports_next_response__WEBPACK_IMPORTED_MODULE_0__/* ["default"].next */ .Z.next();
    else if (!token && path === "/") return next_dist_server_web_exports_next_response__WEBPACK_IMPORTED_MODULE_0__/* ["default"].next */ .Z.next();
    else if (!token && path.includes("/home")) return next_dist_server_web_exports_next_response__WEBPACK_IMPORTED_MODULE_0__/* ["default"].redirect */ .Z.redirect(new URL("/login", req.url));
}
